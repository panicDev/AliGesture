...
#include <string.h>
#include <limits.h>
#include "com_way_gif_GifDrawable.h"
...
Java_com_way_gif_GifDrawable_openFile(JNIEnv * env, jclass class,
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_openByteArray(JNIEnv * env, jclass class,
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_openDirectByteBuffer(JNIEnv * env,
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_openStream(JNIEnv * env, jclass class,
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_openFd(JNIEnv * env, jclass class,
...
Java_com_way_gif_GifDrawable_reset(JNIEnv * env, jclass class,
		jint gifInfo)
{
...
JNIEXPORT void JNICALL
Java_com_way_gif_GifDrawable_setSpeedFactor(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_way_gif_GifDrawable_seekToTime(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_way_gif_GifDrawable_seekToFrame(JNIEnv * env, jclass class,
...
Java_com_way_gif_GifDrawable_renderFrame(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_way_gif_GifDrawable_free(JNIEnv * env, jclass class,
		jint gifInfo)
{
...
Java_com_way_gif_GifDrawable_getComment(JNIEnv * env, jclass class,
		jint gifInfo)
{
	if (gifInfo == (jint) NULL)
		return NULL;
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_getLoopCount(JNIEnv * env, jclass class,
		jint gifInfo)
{
	if (gifInfo ==(jint) NULL)
		return 0;
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_getDuration(JNIEnv * env, jclass class,
		jint gifInfo)
{
	GifInfo* info = (GifInfo*) gifInfo;
	if (info == NULL)
...
JNIEXPORT jint JNICALL
Java_com_way_gif_GifDrawable_getCurrentPosition(JNIEnv * env,
...
JNIEXPORT void JNICALL
Java_com_way_gif_GifDrawable_saveRemainder(JNIEnv * env, jclass class,
		jint gifInfo)
{
	GifInfo* info = (GifInfo*) gifInfo;
	if (info == NULL)
...
JNIEXPORT void JNICALL
Java_com_way_gif_GifDrawable_restoreRemainder(JNIEnv * env,
		jclass class, jint gifInfo)
{
	GifInfo* info = (GifInfo*) gifInfo;
...
Java_com_way_gif_GifDrawable_getAllocationByteCount(JNIEnv * env,
		jclass class, jint gifInfo)
{
	GifInfo* info = (GifInfo*) gifInfo;
	if (info == NULL)
