...
/**
 * An {@link android.widget.ImageButton} which tries treating background and src as
 * {@link com.way.gif.GifDrawable}
 *
 * @author koral--
 */
public class GifImageButton extends ImageButton {
     ...
     * background attributes as {@link com.way.gif.GifDrawable}.
     *
     * @param context
     * @param attrs
     ...
     * {@link android.widget.ImageButton#setImageURI(android.net.Uri)} is called
    ...
    public void setImageURI(Uri uri) {
        if (uri != null)
            try {
                setImageDrawable(new GifDrawable(getContext()
