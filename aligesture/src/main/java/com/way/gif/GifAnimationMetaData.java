...
public class GifAnimationMetaData implements Serializable {
     ...
     * {@link com.way.gif.GifAnimationMetaData#GifAnimationMetaData(java.io.FileDescriptor)}
     *
     * @param afd source
    ...
    /**
     * Retrieves metadata from {@link java.nio.ByteBuffer}. Only direct buffers are
    ...
    public String toString() {
        String loopCount = mMetaData[3] == 0 ? "Infinity" : Integer
                .toString(mMetaData[3]);
        String suffix = String.format(Locale.US,
                "GIF: size: %dx%d, frames: %d, loops: %s, duration: %d",
                mMetaData[0], mMetaData[1], mMetaData[2], loopCount,
                mMetaData[4]);
