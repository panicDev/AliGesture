...
public class GifDrawable extends Drawable implements Animatable, MediaPlayerControl {
     ...
     */
    private int[] mColors;
    private final List<AnimationListener> mListeners = new ArrayList<AnimationListener>();
     ...
     * Convenience wrapper for {@link com.way.gif.GifDrawable#GifDrawable(java.io.FileDescriptor)}
     *
     * @param afd source
     ...
     *
     * @return current error or {@link com.way.gif.GifError#NO_ERROR} if there was no error
     */
    ...
    /**
     * An {@link com.way.gif.GifDrawable#GifDrawable(android.content.res.Resources, int)} wrapper but returns null
