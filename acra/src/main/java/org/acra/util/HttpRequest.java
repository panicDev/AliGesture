...
public final class HttpRequest {
     ...
     * @throws java.io.IOException if the data cannot be posted.
     */
     ...
     * @throws java.io.UnsupportedEncodingException if one of the parameters couldn't be converted to UTF-8.
     */
