 ...
 * {@link org.acra.sender.HttpSender} to send reports to your custom server-side report
 * collection script even if you expect (or prefer) specific names for each
 * report field as {@link org.acra.sender.HttpSender#send(android.content.Context, CrashReportData)}
