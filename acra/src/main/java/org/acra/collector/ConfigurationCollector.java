...
/**
 * Inspects a {@link android.content.res.Configuration} object through reflection API in order to
 * generate a human readable String with values replaced with their constants
 * names. The {@link android.content.res.Configuration#toString()} method was not enough as values
...
public final class ConfigurationCollector {
    ...
    /**
     * Retrieve the name of the constant defined in the {@link android.content.res.Configuration}
     * class which defines the value of a field in a {@link android.content.res.Configuration}
     * instance.
     *
     * @param conf The instance of {@link android.content.res.Configuration} where the value is
     *             stored.
     * @param f    The {@link java.lang.reflect.Field} to be inspected in the {@link android.content.res.Configuration}
     *             instance.
