 ...
 * {@link #init(android.app.Application)} as soon as possible in your {@link android.app.Application}
 * subclass {@link android.app.Application#onCreate()} method. Configuration items must have
 * been set by using {@link ReportsCrashes} above the declaration of your
 * {@link android.app.Application} subclass.
 *
 * @author Kevin Gaudin
 */
public class ACRA {
     ...
     * be placed as soon as possible in the {@link android.app.Application#onCreate()}
     * method.
     * </p>
     *
    ...
    /**
     * Retrieves the {@link android.content.SharedPreferences} instance where user adjustable
