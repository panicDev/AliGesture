...
public enum ReportField {
    ...
    STACK_TRACE_HASH,
    /**
     * {@link android.content.res.Configuration} fields state on the application start.
     *
    ...
    /**
     * {@link android.content.res.Configuration} fields state on the application crash.
     *
     * @see android.content.res.Configuration
     */
    CRASH_CONFIGURATION {
     ...
     * {@link org.acra.ACRA#PREF_USER_EMAIL_ADDRESS} SharedPreference.
     */
    USER_EMAIL,
    /**
     ...
     * {@link org.acra.annotation.ReportsCrashes#applicationLogFile()} to define the path/name of
     * the log file and {@link org.acra.annotation.ReportsCrashes#applicationLogFileLines()} to set
