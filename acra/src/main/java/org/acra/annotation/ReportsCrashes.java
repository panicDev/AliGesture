 ...
 * {@link org.acra.ACRA#init(android.app.Application)} method. The only mandatory
...
public @interface ReportsCrashes {
    ...
    /**
     * If using a custom {@link org.acra.annotation.ReportsCrashes#sharedPreferencesName()}, pass
     ...
     * {@link org.acra.annotation.ReportsCrashes#customReportContent()} to activate alternative
    ...
    /**
     * <p>
     * The {@link org.acra.sender.HttpSender.Method} to be used when posting with {@link #formUri()}.
     * </p>
     *
